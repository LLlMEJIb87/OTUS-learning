...
deny tcp 10.40.0.0 0.0.0.255 10.30.0.0 0.0.0.255 eq www
...
```
## Часть 7. Проверка доступности сервисов с узла B
<image src="https://github.com/LLlMEJIb87/OTUS-learning/blob/master/19.%20ACL/Lab_ssh_B.PNG">
<image src="https://github.com/LLlMEJIb87/OTUS-learning/blob/master/19.%20ACL/Lab_ping_B_ACL.PNG">