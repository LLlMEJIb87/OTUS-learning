...
11. На ПК через командную строку командой "ping" 192.168.1.1 проверил доступность коммутатора, далее подключился по Telnet к коммутатору S1 192.168.1.1
12. Сохранил конфиг командой "copy startup-config running-config"
