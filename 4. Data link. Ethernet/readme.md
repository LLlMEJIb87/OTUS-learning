...
Из таблицы коммутации становится ясно, что есть активные узлы за портами коммутатора:
   ...
   - за портом gigabitethernet0/1 MAC FE80::201:63FF:FEA9:29BC ПК B и MAC интерфейса G0/1 свитча S2 G0/1 0060.2f40.0319
9. С ПК B пропинговал ПК А, S1, S2. Далее на ПК B командой "arp" -a посомтрел arp таблицу 
