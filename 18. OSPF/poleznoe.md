...
Если мы изначально делаем соседство с соседнем маршрутизатором зная, что за интерфесом не будет коммутатора (тоесть он не будет в широковещательном домене), то следует указать тип интерфейса как p2p. Это позволит скоратить время ожидания установления сосседства, так как при широковещательном интерфейсе роутер будет ждать 40 секунд процесса выбора DR и BDR
